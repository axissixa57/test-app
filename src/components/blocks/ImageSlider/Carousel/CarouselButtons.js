...
export const PrevBtn = ({ enabled, onClick }) => (
  <CarouselArrowBtn
    className="carousel__arrowBtn--prev"
    onClick={onClick}
    disabled={!enabled}
  >
    <CarouselArrowBtnSvg viewBox="138 -1.001 366.5 644">
...
export const NextBtn = ({ enabled, onClick }) => (
  <CarouselArrowBtn
    className="carousel__arrowBtn--next"
    onClick={onClick}
    disabled={!enabled}
  >
    <CarouselArrowBtnSvg viewBox="0 0 238.003 238.003">
